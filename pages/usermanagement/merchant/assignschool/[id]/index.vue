...
const showModalDeleteAssgnSchool = ref(false);
...
<template>
  ...
  >
      ...
      <template v-slot:Action="data">
        <div class="flex flex-row">
          <nuxt-link :to="``" class="ml-2">
            <rs-button variant="danger" @click = "showModalDeleteAssgnSchool = true">
   ...
   <rs-modal title="Delete Confirmation" ok-title="Yes" cancel-title="No" :ok-callback="delete" v-model = "showModalDeleteAssgnSchool">
    <p>
      Are you sure want to delete this school ({{ showModalDeleteForm.schoolName }})?
    </p>
  </rs-modal>
