...
<div>
    <div>
      <div class="flex justify-between">
        <h4 class="mb-4 uppercase">Search Merchant Sales</h4>
      </div>
    </div>
       ...
       <FormKit type="form" :actions="false" :incomplete-message="true" @submit="submitForm">
        <div class="flex flex-row justify-between">
             <div class="basis-1/3 mr-5">
                <FormKit v-model="form.paymentMethod" type="select"          
                :options="paymentMethodDropdown"
                label="Payment Method" 
                validation="required|length:0,50" >

                <template #label>
                <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">Payment Method <span class="text-danger">*</span></label>
                </template>
                </FormKit>
             </div>
               ...
               <template v-slot:Action="data">
                 <div class="flex flex-row gap-x-2">
                   <div class="flex items-center gap-x-2">
                      <nuxt-link :to="`/report/merchants/merchant-sales/viewmerchant-sales/`">
