...
<template>
  <div>
    ...
    <rs-card>
      ...
      <template #body>
        <p class="mb-4">
          This page is only accessible by admin and system manager users. You can manage users
    ...
    <rs-modal :title="modalType == 'edit' ? 'Edit User' : 'Add User'"
      ok-title="Save" :ok-callback="saveUser" v-model="showModal">

      <FormKit type="text" v-model="showModalForm.username" name="username" label="Username" :disabled="modalType == 'edit' ? true : false" />
      <FormKit type="text" v-model="showModalForm.fullname" name="fullname" label="Fullname" />
      <FormKit type="text" v-model="showModalForm.email" name="email" Label="Email" validation="email" validation-visibility="dirty"/>
      <FormKit type="mask" v-model="showModalForm.phone" name="phone" label="Phone" mask="###########" />
