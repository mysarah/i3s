...
const data = [
  ...
  {
    "id": "2",
    "examType": "Peperiksaan Pertengahan Tahun",
    "status": "",
    "Action": ""
  },
]
...
<template>
    ...
    <!--<LayoutsBreadcrumb />-->
     <div>
      <div class="flex justify-between">
        <h4 class="mb-4 uppercase">Upload Exam</h4>
      </div>
    </div>
  </div>
      ...
      <FormKit type="form" :actions="false" @submit="submit" :incomplete-message="false" id="myForm" >
        ...
        <div class="flex flex-row justify-between">
          <div class="basis-1/2 mr-5">
            <FormKit type="file" label="Documents" accept=".xlsx,.xml,.csv" validation="required|length:0,200" v-model="form.exam_doc" >
  ...
  <rs-card class="flex-wrap justify-between p-5 bg-white text-black rounded-md flex-col" >   
    ...
    <template #header>
      <div class="flex">List of Exam</div>
    </template>
