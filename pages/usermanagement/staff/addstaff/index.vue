  ...
  <FormKit type="form" :actions="false" :incomplete-message="true" @submit = "submit" >
    <rs-card class="flex-wrap justify-between p-5 bg-white text-black rounded-md flex-col">
      ...
      <div class="p-5">
        ...
        >
          <template #label>
          <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">Address </label>
          </template>
        </FormKit>
        ...
        <div class="flex flex-row justify-between">
          <div class="basis-1/2 mr-5">
            ...
            >
              <template #label>
              <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">Postcode </label>
              </template>
            </FormKit>
          </div>
          <div class="basis-1/2 mr-5">
            ...
            >
              <template #label>
              <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">City </label>
              </template>
            </FormKit>
          </div>
          <div class="basis-1/2 mr-5">
            ...
            >
              <template #label>
              <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">State </label>
              </template>
            </FormKit>
          </div>
          <div class="basis-1/2">
    ...
    <rs-card class="flex-wrap justify-between p-5 bg-white text-black rounded-md flex-col">
      ...
      <div class="flex flex-row justify-between p-5">
        <div class="basis-1/2 mr-5">
          ...
          >
            <template #label>
            <label class="formkit-label text-gray-700 dark:text-gray-200 block mb-2 font-semibold text-sm formkit-invalid:text-red-500">Wallet Number</label>
            </template>
          </FormKit>
        </div>
        <div class="basis-1/2 mr-5">
